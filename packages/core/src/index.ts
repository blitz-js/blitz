...
type ControllerInput = ({db: PrismaClient}) => ControllerDefinition
...
export function Controller(getController: ControllerInput): ControllerInstance {
...
export const harnessServerProps = (Controller: ControllerInstance) => ctx => {
