            ...
            <div className={styles.layout}>
              <div className={styles.header}>
                  ...
                  <div className={styles.scribbleContainer}>
                    <span>Your database & authentication is already setup. Try it out by clicking Sign Up</span>
                    <svg version="1.1" id="Capa_1" x="0px" y="0px" width="352.2px" height="352.2px" viewBox="0 0 352.2 352.2">
                      <g>
              ...
              <div className={styles.instructions}>
                ...
                <div>
                  ...
                  <p>
                    and ✨ go to{" "}
                    <Link href="/projects">
                      <a className={styles.textLink}>/projects</a>
                    </Link>
                  </p>
                </div>
              </div>
