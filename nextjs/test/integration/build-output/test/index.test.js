...
describe('Build Output', () => {
  describe('Basic Application Output', () => {
    ...
    it('should not deviate from snapshot', async () => {
      ...
      expect(parseFloat(indexFirstLoad)).toBeCloseTo(66.7, 1)
      expect(indexFirstLoad.endsWith('kB')).toBe(true)

      expect(parseFloat(err404Size) - 3.7).toBeLessThanOrEqual(0)
      expect(err404Size.endsWith('kB')).toBe(true)

      expect(parseFloat(err404FirstLoad)).toBeCloseTo(69.8, 0)
      expect(err404FirstLoad.endsWith('kB')).toBe(true)

      expect(parseFloat(sharedByAll)).toBeCloseTo(66.4, 1)
