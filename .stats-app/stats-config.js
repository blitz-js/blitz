const clientGlobs = [
  ...
  },
  {
    ...
    globs: [".next/static/runtime/+(main|webpack)-*.module.js", ".next/static/chunks/*.module.js"],
  },
  {
...
module.exports = {
  ...
  appBuildCommand: "NEXT_TELEMETRY_DISABLED=1 yarn build",
  appStartCommand: "NEXT_TELEMETRY_DISABLED=1 yarn start --production --port $PORT",
  mainRepo: "blitz-js/blitz",
  mainBranch: "canary",
  autoMergeMain: true,
  configs: [
    {
      ...
      pagesToBench: ["http://localhost:$PORT/", "http://localhost:$PORT/error-in-render"],
      benchOptions: {
        reqTimeout: 60,
        concurrency: 50,
        numRequests: 2500,
