...
const runTests = () => {
  describe("Blitz Custom Plugin", () => {
    describe("Custom plugin loaded", () => {
      it("should log custom plugin loaded", async () => {
        await waitFor(5000)
        expect(console.log).toHaveBeenCalledWith("Custom plugin loaded")
      })
    })
  }),
    describe("Auth", () => {
