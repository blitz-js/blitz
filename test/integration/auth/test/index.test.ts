...
const runTests = (mode: string) => {
  describe("Auth", () => {
    describe("unauthenticated", () => {
      ...
      //   await browser.waitForElementByCss("#error", 0)
    ...
    //       const browser = await webdriver(appPort, "/login")
    //       await waitFor(200)
    //       let text = await browser.elementByCss("#content").text() as any
    ...
    //       await browser.waitForElementByCss("#change-role", 0)
    //       await browser.elementByCss("#change-role").click()
    //       await waitFor(500)
    //       await browser.waitForElementByCss(".role", 0)
    //       // @ts-ignore
    //       const roleElementsAfter = await browser.elementsByCss(".role") as any
